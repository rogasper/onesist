...
The headline items live in PLAYBOOK.md Phase 3. The full catalog:

- **DRY violations**: near-duplicate code blocks that should be unified — but only if they encode the same rule. See NEVER list in PLAYBOOK.md on premature DRY.
