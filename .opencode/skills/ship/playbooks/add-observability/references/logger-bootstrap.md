...
Loaded only when PLAYBOOK.md Phase 2 detection finds **no** existing logger. If detection found one, do not load this file — conform to the existing API instead.
