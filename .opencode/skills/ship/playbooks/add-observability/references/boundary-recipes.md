...
`log` is the import path you wrote down at the end of PLAYBOOK.md Phase 2. Replace `log` below with whatever the project actually exports.
...
The replacement table from PLAYBOOK.md Phase 4 in expanded form:
